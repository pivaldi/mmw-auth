...
var (
	_ authdef.AuthPublicService  = (*ContractAdapter)(nil)
	_ authdef.AuthPrivateService = (*ContractAdapter)(nil)
)
...
func (a *ContractAdapter) Register(ctx context.Context, req *authv1.RegisterRequest) (*authv1.RegisterResponse, error) {
	...
	if err != nil {
		return nil, eris.Wrap(mapper.DomainErrorFor(err), "register")
	}
...
func (a *ContractAdapter) Login(ctx context.Context, req *authv1.LoginRequest) (*authv1.LoginResponse, error) {
	...
	if err != nil {
		return nil, eris.Wrap(mapper.DomainErrorFor(err), "login")
	}
...
func (a *ContractAdapter) ValidateToken(
	ctx context.Context, req *authv1.ValidateTokenRequest,
) (*authv1.ValidateTokenResponse, error) {
	userID, err := a.svc.ValidateToken(ctx, req.GetToken())
	if err != nil {
		return nil, eris.Wrap(mapper.DomainErrorFor(err), "validate token")
	}
...
func (a *ContractAdapter) ChangePassword(
	ctx context.Context, req *authv1.ChangePasswordRequest,
	...
	if err := a.svc.ChangePassword(ctx, userID, req.GetOldPassword(), req.GetNewPassword()); err != nil {
		return nil, eris.Wrap(mapper.DomainErrorFor(err), "change password")
	}
...
func (a *ContractAdapter) DeleteUser(
	ctx context.Context, req *authv1.DeleteUserRequest,
	...
	if err := a.svc.DeleteUser(ctx, userID); err != nil {
		return nil, eris.Wrap(mapper.DomainErrorFor(err), "delete user")
	}
